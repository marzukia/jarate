...
export interface AgentController {
    ...
    cancelQueued(entryId: string, context: Context): Promise<{
        outcome: "cancelled" | "already_consumed" | "not_found";
    }>;
...
export declare const AgentController: import("@earendil-works/chord").Service<AgentController>;
