...
export interface SlashCommandContribution {
    ...
    getArgumentCompletions?(argumentPrefix: string): readonly SlashCommandCompletion[] | null | Promise<readonly SlashCommandCompletion[] | null>;
...
export declare const SlashCommands: import("@earendil-works/chord").Service<SlashCommands>;
