 ...
 */
import { AgentHarness, BACKGROUND_CONTEXT, createBashTool, createEditTool, createReadTool, createWriteTool, JsonlSessionRepo, } from "@earendil-works/pi-agent-core";
import { NodeExecutionEnv } from "@earendil-works/pi-agent-core/node";
import { findInitialModel } from "../../../core/model-resolver.js";
import { ModelRuntime } from "../../../core/model-runtime.js";
import { Lane, Models, Worker } from "../shared/protocol.js";
import { createPeer } from "../shared/rpc.js";
import { parentConnection } from "../shared/transport.js";
import { LaneService } from "./lane-service.js";
...
async function openSession(repo, sessionId, cwd, context) {
    if (sessionId === undefined)
        return repo.create({ cwd }, context);
...
export async function runSessionWorker(options) {
    ...
    if (!model)
        throw new Error("No model available. Configure credentials with `pi` first.");
