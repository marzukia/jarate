...
export type AuthPromptRequest = AuthPrompt extends infer Prompt ? Prompt extends unknown ? Omit<Prompt, "signal"> : never : never;
...
export declare function defineService<TApi extends object, TEvent = never>(name: string): ServiceToken<TApi, TEvent>;
...
export type AuthEventPayload = Exclude<ModelsEvent, {
    type: "state";
}>;
...
export declare const Lane: ServiceToken<LaneServiceApi, LaneEvent>;
/** Provided by the worker. Small enough to publish whole. */
export declare const Models: ServiceToken<ModelsServiceApi, ModelsEvent>;
/** Provided by the worker, consumed only by the server. */
export declare const Worker: ServiceToken<WorkerServiceApi, never>;
/** Provided by the server. */
export declare const Sessions: ServiceToken<SessionsServiceApi, never>;
