...
export declare function valueOption<TValue>(name: `-${string}`, parse: (value: string) => CommandOptionParseResult<TValue>, options?: {
    readonly repeatable?: boolean;
}): CommandOption<TValue>;
export declare function stringOption(name: `-${string}`, options?: {
    readonly repeatable?: boolean;
}): CommandOption<string>;
export declare function flagOption(name: `-${string}`): CommandOption<boolean>;
